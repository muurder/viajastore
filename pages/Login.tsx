                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            type="email"
                            required
                            className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:bg-white focus:ring-primary-500 focus:border-primary-500 sm:text-sm outline-none transition-all duration-200"
                        ...
                        <div className="relative">
                            ...
                            required
                            className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:bg-white focus:ring-primary-500 focus:border-primary-500 sm:text-sm outline-none transition-all duration-200"
                            placeholder="••••••••"
                            value={password}
