...
// Fix: Added useSearchParams and Link for react-router-dom
...
// Fix: Define StatCard component locally and completely
...
// FIX: Changed from named export 'AdminDashboard' to 'MasterAdminDashboard'
