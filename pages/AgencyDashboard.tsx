...
const AgencyDashboard: React.FC = () => {
  ...
  const { trips, bookings, createTrip, updateTrip, deleteTrip, toggleTripStatus, refreshData, loading: dataLoading, agencyReviews: allAgencyReviews, clients } = useData();
  ...
  console.log("AgencyDashboard:agencies →", clients);
