...
export const AgencyDashboard: React.FC = () => {
  ...
  const [newTripFormData, setNewTripFormData] = useState<Partial<Trip>>({
    ...
    category: TripCategory.PRAIA, tags: [], travelerTypes: [], // Fix: Use enum for category
                              ...
                              {myTrips.map(trip => (
                                  <tr key={trip.id} className="hover:bg-gray-50 transition-colors">
                                      ...
                                      <td className="px-6 py-4 text-right">
                                          <TripActionsMenu // Fix: Changed to TripActionsMenu
                                              trip={trip}
            ...
            <form onSubmit={handleTripFormSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <select 
                            value={newTripFormData.category || TripCategory.PRAIA} // Fix: Use TripCategory.PRAIA
