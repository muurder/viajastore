...
if (!supabaseUrl || supabaseUrl === 'https://seu-projeto-id.supabase.co' || supabaseUrl === 'https://placeholder.supabase.co' || !supabaseKey || supabaseKey === 'placeholder') {
  ...
  console.warn('Verifique se você criou o arquivo .env na raiz com VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY reais do seu painel. O app usará dados de exemplo.');
} else {
