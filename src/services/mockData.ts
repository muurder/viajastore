...
export const MOCK_TRIPS: Trip[] = [
  ...
  // --- Rio de Janeiro (ag_2) ---
  {
    ...
    is_active: true,
    tripRating: 4.8, // Corrected
    tripTotalReviews: 210, // Corrected
  ...
  // --- Amazônia (ag_3) ---
  {
    ...
    is_active: true,
    tripRating: 5.0, // Corrected
    tripTotalReviews: 89, // Corrected
   ...
   // --- Fernando de Noronha (ag_4) ---
  {
    ...
    is_active: true,
    tripRating: 4.9, // Corrected
    tripTotalReviews: 150, // Corrected
  ...
  // --- Chapada Diamantina (ag_7) ---
  {
    ...
    is_active: true,
    tripRating: 4.9, // Corrected
    tripTotalReviews: 132, // Corrected
   ...
   // --- Rota do Vinho SP (ag_8) ---
   {
    ...
    paymentMethods: ['Pix'],
    is_active: true,
    tripRating: 4.7, // Corrected
    tripTotalReviews: 88, // Corrected
  ...
  // --- Trindade (ag_9) ---
  {
    ...
    paymentMethods: ['Pix', 'Boleto'],
    is_active: true,
    tripRating: 4.6, // Corrected
    tripTotalReviews: 112, // Corrected
