...
export const MOCK_TRIPS: Trip[] = [
  // --- Cataratas do Iguaçu (ag_1) ---
  {
    ...
    category: TripCategory.NATUREZA,
  ...
  // --- Amazônia (ag_3) ---
  {
    ...
    category: TripCategory.AVENTURA,
  ...
  // --- Chapada Diamantina (ag_7) ---
  {
   ...
   // --- Rota do Vinho SP (ag_8) ---
   {
    ...
    category: TripCategory.GASTRONOMICO,
  ...
  // --- Trindade (ag_9) ---
  {
    ...
    category: TripCategory.VIAGEM_BARATA,
