...
const Home: React.FC = () => {
  ...
  const heroWhatsAppLink = (currentHeroAgency?.whatsapp || currentHeroAgency?.phone && currentHeroTrip) 
      ? buildWhatsAppLink(currentHeroAgency.whatsapp || currentHeroAgency.phone, currentHeroTrip) 
      : null;
