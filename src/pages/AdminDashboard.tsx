                    ...
                    <div className="py-1">
                        {actions.map((action, idx) => (
                            <button 
                                ...
                                className={`w-full text-left px-4 py-2.5 text-sm font-medium flex items-center gap-3 transition-colors ${action.variant === 'danger' ? 'text-red-600 hover:bg-red-50' : 'text-gray-700 hover:bg-50'}`}
                            >
