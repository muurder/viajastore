...
export const About: React.FC = () => (
  <div className="max-w-4xl mx-auto space-y-12 py-12 animate-[fadeIn_0.3s]">
    <div className="text-center">
      ...
      <p className="text-xl text-gray-500 max-w-2xl mx-auto">O SouNativo nasceu para eliminar barreiras entre quem sonha em viajar e quem realiza sonhos.</p>
    </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div><p className="text-xs font-bold text-gray-400 uppercase">Email</p><p className="font-medium">suporte@sounativo.com</p></div>
                </div>
                <div className="flex items-center gap-4">
...
export const Careers: React.FC = () => (
    <div className="max-w-3xl mx-auto py-12 text-center">
        ...
        <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100">
            ...
            <p className="text-gray-600">Mas estamos sempre de olho em talentos! Envie seu currículo para <strong>talentos@sounativo.com</strong></p>
        </div>
    </div>
);
